...
# 서울 자치구 법정동코드 앞 5자리 (국토부 실거래 API LAWD_CD)
SEOUL_LAWD_CD = {
    "종로구": "11110",
    "중구": "11140",
    "용산구": "11170",
...
# 국토부 아파트 매매 실거래 수집
MOLIT_TRADE_START_YM = "200601"
MOLIT_REQUEST_DELAY = 0.25
TRACKED_DISTRICTS_CSV = "tracked_districts.csv"
TRACKED_COMPLEXES_CSV = "tracked_complexes.csv"
TRADE_HISTORY_CSV = "apt_trades.csv"
